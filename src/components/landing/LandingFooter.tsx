        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div>
              ...
              <a
                href="https://discord.gg/your-discord-server" // Replace with your actual Discord invite link
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-500 hover:to-blue-500 text-white rounded-2xl transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-110 font-bold backdrop-blur-sm border border-indigo-500/20"
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-700">
              ...
              <li>
                <a href="#feedback-form" className="hover:text-blue-600 hover:font-semibold font-medium transition-all duration-200 hover:underline">
                  Contact Me
                </a>
              </li>
            </ul>
