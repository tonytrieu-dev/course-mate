...
const TaskView: React.FC<TaskViewProps> = ({ onTaskEdit }) => {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-gray-700 p-4 h-full flex flex-col hover:shadow-xl transition-smooth">
      {/* Header */}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
          ...
          <div>
            <input
              ...
              className="w-full px-3 py-3 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-[44px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
            />
          </div>
          ...
          <div>
            <select
              ...
              className="w-full px-3 py-3 sm:py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 min-h-[44px] touch-manipulation bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
            >
        ...
        <div className="flex flex-wrap gap-4 items-center">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
            >
          ...
          <button
            ...
            className="flex items-center gap-1 px-3 py-2 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 transition-colors min-h-[44px] touch-manipulation rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
          >
      ...
      {/* Bulk Actions */}
      {showBulkActions && (
        <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-3 mb-4 flex flex-wrap items-center justify-between gap-2">
              ...
              return (
                <div
                  ...
                  className={`p-4 sm:p-4 rounded-xl border-l-4 ${style.border} ${
                    task.completed ? 'bg-gray-50 dark:bg-gray-800 opacity-75' : 'bg-white dark:bg-gray-700'
                  } shadow-md hover:shadow-lg transition-smooth cursor-pointer group min-h-[64px] touch-manipulation border border-gray-100 dark:border-gray-600 hover:border-gray-200 dark:hover:border-gray-500`}
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <input
                      ...
                      className="mt-1 h-5 w-5 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded touch-manipulation bg-white dark:bg-gray-700"
                    />
                    ...
                    <button
                      ...
                      className={`mt-1 h-6 w-6 rounded border-2 flex items-center justify-center transition-colors touch-manipulation hover:scale-105 active:scale-95 ${
                        task.completed
                          ...
                          : 'border-gray-300 dark:border-gray-600 hover:border-green-400 dark:hover:border-green-500 bg-white dark:bg-gray-700'
                      }`}
                    >
                      {task.completed && (
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h3 className={`font-semibold ${task.completed ? 'line-through text-gray-500 dark:text-gray-400' : 'text-gray-900 dark:text-gray-100'} ${overdue ? 'text-red-600 dark:text-red-400' : ''}`}>
                            {task.title}
